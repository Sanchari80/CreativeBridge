      ...
      {view === 'landing' ? (
        ...
        <div style={authCard}>
          ...
          <h2 style={{ marginBottom: '20px', color: '#2d3436' }}>
            {view === 'login' ? 'Welcome Back' : 'Join the Bridge'}
          </h2>
...
const containerStyle = { 
  ...
  alignItems: 'center', 
  backgroundImage: "url('/auth background.png')", // আপনার রিকোয়েস্ট অনুযায়ী ইমেজ সেট করা হয়েছে
